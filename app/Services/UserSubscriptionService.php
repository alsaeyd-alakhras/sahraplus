...
{
    public function __construct(private UserSubscriptionRepository $repo) {}
    ...
    public function datatableIndex(Request $request)
    {
        ...
        return DataTables::of($q)
            ...
            ->addColumn('user_id', function ($row) {
                ...
                return $row->starts_at ? \Carbon\Carbon::parse($row->starts_at)->format('d-m-Y') : '';
            })
            ->addColumn('ends_at', function ($row) {
                return $row->ends_at ? \Carbon\Carbon::parse($row->ends_at)->format('d-m-Y') : '';
