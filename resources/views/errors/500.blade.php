...
<div class="wrapper vh-100">
    <div class="mx-auto align-items-center h-100 d-flex w-50">
        <div class="mx-auto text-center">
            <h1 class="m-0 display-1 font-weight-bolder text-danger" style="font-size:80px;">500</h1>
            <h1 class="mb-1 text-muted font-weight-bold">OOPS!</h1>
            <h4 class="mb-3 text-black">حدث بالإتصال بالسيرفر يرجى التواصل مع المهندس بهذا اللحظة</h4>
