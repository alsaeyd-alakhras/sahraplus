            ...
            <div class="pt-4 card-body">
                <div class="row">
                    <div class="mb-4 col-md-6">
                        <x-form.input label="اسم الدولة بالعربي" :value="$country->name_ar" name="name_ar" placeholder="فلسطين ...."
                            required autofocus />
                    </div>
                    <div class="mb-4 col-md-6">
                    ...
                    <div class="mb-4 col-md-6">
                        <x-form.input label="كود الدولة" :value="$country->code" name="code" placeholder="code" required />
                    </div>
                    <div class="mb-4 col-md-6">
                        <x-form.input label="ديال الكود" :value="$country->dial_code" name="dial_code" placeholder="Dial Code"
                            required />
                    </div>
                    <div class="mb-4 col-md-6">
                        <x-form.input label="العملة" :value="$country->currency" name="currency" placeholder="العملات" required />
                    </div>
                    <div class="mb-4 col-md-6">
