<x-dashboard-layout>
    ...
    @php
        $fields = [
            ...
            'profile_id' => __('admin.profile'),
            'last_activity' => __('admin.last_activity'),
            'ip_address' => __('admin.ip_address'),
            'device_id' => __('admin.device'),
    ...
    @push('scripts')
        ...
        <script>
            ...
            const urlIndex = `{{ route('dashboard.active_devices.index') }}`;


            // أسماء الحقول للفلترة في الهيدر
            const fields = ['#', 'user_id', 'profile_id', 'last_activity', 'ip_address', 'device_id', 'is_active'];
