<div class="row">
    <div class="col-md-12">
        <!-- Profile Header Card -->
        <div class="mb-4 shadow-lg card border-0 bg-gradient-primary">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="position-relative me-4">
                                <img src="{{ $user->avatar_url }}" alt="user-avatar" 
                                    class="rounded-circle border-4 border-white shadow-sm d-block"
                                    id="uploadedAvatar" style="width: 120px; height: 120px; object-fit: cover;" />
                                <div class="position-absolute bottom-0 end-0">
                                    <label for="upload" class="btn btn-light btn-sm rounded-circle p-2 shadow" tabindex="0">
                            ...
                            <div class="text-white">
                                <h4 class="mb-1 fw-bold">{{ $user->first_name ?? 'مستخدم جديد' }} {{ $user->last_name ?? '' }}</h4>
                                <p class="mb-2 opacity-75">
                                    <i class="ti ti-mail me-1"></i>{{ $user->email ?? 'بريد إلكتروني جديد' }}
                                </p>
                                <small class="opacity-75">مسموح: JPG, PNG أو GIF (الحد الأقصى: 5MB)</small>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="bg-white bg-opacity-10 rounded p-3">
                            <x-form.selectkey required label="نوع المستخدم" id="user-type" name="user_type" :selected="$user->user_type ?? 'vendor'"
                                :options="['admin' => 'مشرف', 'user' => 'مستخدم', 'vendor' => 'مزود']" class="form-select-white" />
                        </div>
                    </div>
                </div>
            </div>
