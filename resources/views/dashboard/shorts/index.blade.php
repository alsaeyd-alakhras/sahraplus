<x-dashboard-layout>
    ...
    @php
        ...
        $fields = [
            ...
            'likes_count' => __('admin.likes_count'),
            'comments_count' => __('admin.comments_count'),
            'shares_count' => __('admin.shares_count'),
            'aspect_ratio' => __('admin.aspect_ratio'),
        ...
        <div class="enhanced-card-body">
            <div class="col-12" style="padding: 0;">
                <div class="table-container">
                    <table id="shorts-table" class="table enhanced-sticky table-striped table-hover"
            ...
            const columnsTable = [{
                ...
                // العمليات
                {
                    ...
                    render: function(id) {
                        ...
                        if (abilityShow) {
                            linkshow =
                                `<a href="${urlShow.replace(':id', id)}" class="action-btn btn-show" title="عرض"><i class="fas fa-eye"></i></a>`;
                        }
                        if (abilityEdit) {
                            linkedit =
                                `<a href="${urlEdit.replace(':id', id)}" class="action-btn btn-edit" title="تعديل"><i class="fas fa-edit"></i></a>`;
                        }
                        if (abilityDelete) {
                            linkdelete =
                                `<button class="action-btn btn-delete delete_row" data-id="${id}" title="حذف"><i class="fas fa-trash"></i></button>`;
                        }
