<x-dashboard-layout>
    ...
    @push('scripts')
        ...
        <script>
            ...
            const urlIndex = `{{ route('dashboard.userRatings.index') }}`;
            const urlFilters = `{{ route('dashboard.userRatings.filters', ':column') }}`;
            const urlCreate = '{{ route('dashboard.userRatings.create') }}';
            const urlShow = '{{ route('dashboard.userRatings.show', ':id') }}';
            const urlEdit = '{{ route('dashboard.userRatings.edit', ':id') }}';
            const urlDelete = '{{ route('dashboard.userRatings.destroy', ':id') }}';
